        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between relative">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-white font-extrabold text-sm sm:text-lg md:text-xl tracking-wide sm:tracking-widest uppercase shimmer-text">GeoFest 2026</span>
              <span className="text-amber-400 text-[8px] sm:text-[9px] md:text-[10px] font-semibold tracking-widest uppercase">Strata</span>
            </div>
          </Link>
