    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between relative">
          ...
          {/* College logos — all screens */}
          <div className="flex items-center gap-2 sm:gap-4 absolute left-1/2 -translate-x-1/2">
            <img src="/NICMAR_LOGO1.jpeg" alt="NICMAR Logo" className="h-8 sm:h-12 w-auto object-contain rounded-lg sm:rounded-xl shadow-[0_0_18px_4px_rgba(200,200,200,0.35)]" />
            <img src="/NICMARLOGO2.jpeg"  alt="NICMAR Logo 2" className="h-8 sm:h-12 w-auto object-contain rounded-lg sm:rounded-xl shadow-[0_0_18px_4px_rgba(200,200,200,0.35)]" />
          </div>
